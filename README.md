...
For a deep dive into the ULMFiT approach, model architectures, regularization and training strategies, see the [Methods Long Form](https://github.com/tejasvi/DNAish/blob/master/Methods/Methods%20Long%20Form.ipynb) document in the Methods section.
